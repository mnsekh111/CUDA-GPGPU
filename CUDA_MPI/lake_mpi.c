...
void run_cpu9pt_mpi(double *u, double *u0, double *u1, double *pebbles, int n,
		double h, double end_time);
extern void run_gpu9pt_mpi(double *u, double *u0, double *u1, double *pebbles,
...
void do_transfer(double* uc, int n) {
	...
	case 0:
		...
		MPI_Irecv(rec_down_border, n, MPI_DOUBLE, 2, DEFAULT_TAG,
				MPI_COMM_WORLD, &reqs[1]);
		MPI_Irecv(&rec_cornor, 1, MPI_DOUBLE, 3, DEFAULT_TAG, MPI_COMM_WORLD,
				&reqs[2]);
		...
		MPI_Isend(send_down_border, n, MPI_DOUBLE, 2, DEFAULT_TAG,
				MPI_COMM_WORLD, &reqs[4]);
		MPI_Isend(&send_cornor, 1, MPI_DOUBLE, 3, DEFAULT_TAG, MPI_COMM_WORLD,
				&reqs[5]);
		break;
	...
	case 1:
		...
		MPI_Irecv(rec_down_border, n, MPI_DOUBLE, 3, DEFAULT_TAG,
				MPI_COMM_WORLD, &reqs[1]);
		MPI_Irecv(&rec_cornor, 1, MPI_DOUBLE, 2, DEFAULT_TAG, MPI_COMM_WORLD,
				&reqs[2]);
		...
		MPI_Isend(send_down_border, n, MPI_DOUBLE, 3, DEFAULT_TAG,
				MPI_COMM_WORLD, &reqs[4]);
		MPI_Isend(&send_cornor, 1, MPI_DOUBLE, 2, DEFAULT_TAG, MPI_COMM_WORLD,
				&reqs[5]);
	...
	case 2:
		...
		MPI_Irecv(rec_right_border, n, MPI_DOUBLE, 3, DEFAULT_TAG,
				MPI_COMM_WORLD, &reqs[0]);
		MPI_Irecv(rec_top_border, n, MPI_DOUBLE, 0, DEFAULT_TAG, MPI_COMM_WORLD,
				&reqs[1]);
		MPI_Irecv(&rec_cornor, 1, MPI_DOUBLE, 1, DEFAULT_TAG, MPI_COMM_WORLD,
				&reqs[2]);
		...
		MPI_Isend(send_top_border, n, MPI_DOUBLE, 0, DEFAULT_TAG,
				MPI_COMM_WORLD, &reqs[4]);
		MPI_Isend(&send_cornor, 1, MPI_DOUBLE, 1, DEFAULT_TAG, MPI_COMM_WORLD,
				&reqs[5]);
		break;
	case 3:
		...
		MPI_Irecv(rec_left_border, n, MPI_DOUBLE, 2, DEFAULT_TAG,
				MPI_COMM_WORLD, &reqs[0]);
		MPI_Irecv(rec_top_border, n, MPI_DOUBLE, 1, DEFAULT_TAG, MPI_COMM_WORLD,
				&reqs[1]);
		MPI_Irecv(&rec_cornor, 1, MPI_DOUBLE, 0, DEFAULT_TAG, MPI_COMM_WORLD,
				&reqs[2]);
		...
		MPI_Isend(send_top_border, n, MPI_DOUBLE, 1, DEFAULT_TAG,
				MPI_COMM_WORLD, &reqs[4]);
		MPI_Isend(&send_cornor, 1, MPI_DOUBLE, 0, DEFAULT_TAG, MPI_COMM_WORLD,
				&reqs[5]);
		break;
